// src/components/BookmarkTree/BookmarkTreeIcons.tsx
 ...
 * 메뉴 아이템 아이콘 (페이지)
 */
export function MenuItemIcon({ className, size = 16 }: IconProps): ReactElement {
    return (
        <svg
            className={classNames("menu-item-icon", className)}
            width={size}
            height={size}
            viewBox="0 0 24 24"
            fill="none"
